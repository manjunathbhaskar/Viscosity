...
const LOG_LINES = [
  ...
  "[SWARM] Reviewer #017 (skeptic) sentiment: -0.62",
  "[SWARM] Reviewer #204 (optimist) sentiment: +0.81",
  "[TRUST] dataVolume 0.33 x cleanliness 0.80 x agreement 0.50",
  "[SWARM] Red-team pass found kill-shot candidate, p=0.08",
  "[AUDIO] Triggering ElevenLabs synthesis bridge...",
  "[DILIGENCE] Red flag scan: benford 0.12, coc 0.08, gaps 0.03",
  "[SWARM] Orchestrator synthesizing scenario 2/2...",
